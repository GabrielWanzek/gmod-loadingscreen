...
if (isset($_GET['mapname'])){
    ...
    die("<img src='img/ohno.jpg' style='margin-top: 20px height='256' width='256';' /><br />Woops, you don't seem to be using the correct extension in the address bar to get the loading screen to work.<br />
    Please make sure it has the correct extension it should have ?steamid= at the end of it and look something like this: www.yourdomain.com/loading/index.php?steamid=%s&mapname=%m<br /><br />
